...
# date: 11/26/2018
"""
# file name: client_2.py
# description:
#   0. This the client 2 file. Almost the same as client_1.py except the id. To simulate real use case, using separate
...
if __name__ == "__main__":
    try:
        client = DNSClient("PC2", '127.0.0.1', 5352)
